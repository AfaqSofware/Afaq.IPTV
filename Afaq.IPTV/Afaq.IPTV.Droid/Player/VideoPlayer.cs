...
namespace Afaq.IPTV.Droid.Player
{
        ...
        MetadataTrackRenderer.IMetadataRenderer, DebugTextViewHelper.IProvider
    {
        ...
        {
            StateIdle = ExoPlayer.StateIdle,
            StatePreparing = ExoPlayer.StatePreparing,
            StateBuffering = ExoPlayer.StateBuffering,
            StateReady = ExoPlayer.StateReady,
            StateEnded = ExoPlayer.StateEnded,
            TrackDisabled = ExoPlayer.TrackDisabled,
            TrackDefault = ExoPlayer.TrackDefault
        }

        // Constants pulled into this class for convenience.
        public const int StateIdle = ExoPlayer.StateIdle;
        public const int StatePreparing = ExoPlayer.StatePreparing;
        public const int StateBuffering = ExoPlayer.StateBuffering;
        public const int StateReady = ExoPlayer.StateReady;
        public const int StateEnded = ExoPlayer.StateEnded;
        public const int TrackDisabled = ExoPlayer.TrackDisabled;
        public const int TrackDefault = ExoPlayer.TrackDefault;
